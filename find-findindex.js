...
should remove the object from the array. If the object is not found, 
return undefined. 
...
function removeUser(usersArray, username) {
    const foundI = usersArray.findIndex(function(val) {
      console.log(val.username);
      console.log(username);
      return val.username === username;
 
  });
  if(foundI === -1) { // if we don't find anything, return
    return;
  }
  return usersArray.splice(foundI,1) [0]; // modify array if found.
